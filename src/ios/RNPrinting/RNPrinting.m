...
RCT_EXPORT_METHOD(print2:(NSDictionary *)options
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
  ...
  // Use UIWebView to load the data and then print the UIWebView
  if(![UIPrintInteractionController canPrintData:printData]){
    ...
    DoveWebView *myWebView = [[DoveWebView alloc] initWithFrame:CGRectMake(0,0,screenSize.width,screenSize.height)];
